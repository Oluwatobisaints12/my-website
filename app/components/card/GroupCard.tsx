    ...
    <div className='mt-[2.5rem] flex md:justify-center md:items-center  lg:justify-center lg:items-center lg:mt-[8.4375rem]'>
      <div className='w-full flex flex-col gap-[12px] md:w-full md:justify-between md:flex-row md:max-w-[726px] lg:justify-between lg:flex-row lg:max-w-[1262px]'>
        <div className='border-[#D0D5DD] rounded-[12px] border py-[1.75rem] px-[1rem] w-full lg:max-w-[616px]'>
          <h1 className={` ${generalSemiBold.className} ${theme === "light" ? 'text-black' : 'text-white'} text-[1.25rem] md:text-[1.75rem] lg:text-[2.5rem]`}>What You`ll Learn</h1>
        ...
        <div className='border-[#D0D5DD] rounded-[12px] border py-[2.7rem] px-[1rem] w-full lg:max-w-[616px]'>
          <h1 className={` ${generalSemiBold.className} ${theme === "light" ? 'text-black' : 'text-white'} text-[1.25rem] md:text-[1.75rem] lg:text-[2.5rem]`}>How It Works</h1>
          <nav className='gap-[1rem] flex flex-col'>
