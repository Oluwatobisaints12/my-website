...
const MentorshipText = () => {
  ...
  <div className='w-full md:w-full md:max-w-[726px] lg:max-w-[1262px] lg:mt-[8rem] '>
      ...
      <h1 className={`${generalSemiBold.className} text-[1.75rem] md:text-[2.25rem] lg:text-[4rem] ${theme === "light" ? 'text-black' : 'text-white'}`}>Mentorship with Great Chisom Anosike</h1>
